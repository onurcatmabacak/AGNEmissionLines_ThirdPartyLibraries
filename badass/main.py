...
#     "amp_plim": (0,1), # line amplitude parameter limits; default (0,)
    "disp_plim": (0,1200), # line dispersion parameter limits; default (0,)
...
#     "amp_plim": (0,40), # line amplitude parameter limits; default (0,)
    "disp_plim": (1200,10000), # line dispersion parameter limits; default (0,)
...
test_options = {
    "test_mode":"config", # line or config
...
fontsize=14
ax1.set_title(f"Keck/LRIS Un-normalized, Observed Spectrum Input, z={z:.3f} (Sexton et al. 2019)",fontsize=fontsize)
...
badass.run_BADASS(pathlib.Path(file),
                  ...
                  fwhm_res             = 114, # linear FWHM resolution in Angstroms
                  z                    = 0.348, # BADASS assumes spectrum is NOT corrected for redshift.
                  ebv                  = 0.19, # for Galactic extinction correction.
                  flux_norm            = 1.E-17, # Don't forget the flux normalization!
                 )
    #