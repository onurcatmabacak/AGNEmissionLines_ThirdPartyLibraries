...
broad_options ={
    "amp_plim": (0,1000), # line amplitude parameter limits; default (0,)
    "disp_plim": (0,1000), # FWHM, line dispersion parameter limits; default (0,)
...
test_options = {
    ...
    "lines": [["NA_OIII_5007","NA_OIII_4960","NA_H_BETA","NA_H_ALPHA"]], 
