...
var _arrayLikeKeys = __webpack_require__(86791);
// EXTERNAL MODULE: ../node_modules/lodash-es/isObject.js
var isObject = __webpack_require__(60417);
// EXTERNAL MODULE: ../node_modules/lodash-es/_isPrototype.js
var _isPrototype = __webpack_require__(89418);
...
/* harmony export */ });
/* harmony import */ var _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11493);
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(calculateDeltaAndAngle, "calculateDeltaAndAngle");
var pointTransformer = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((data) => {
  if (Array.isArray(data)) {
    return { x: data[0], y: data[1] };
  }
  return data;
}, "pointTransformer");
var getLineFunctionsWithOffset = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((edge) => {
  return {
    x: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(d, i, data) {
      let offset = 0;
    ...
    y: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(d, i, data) {
      let offset = 0;
...
var getSubGraphTitleMargins = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(({
  flowchart
}) => {
...
/* harmony import */ var _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(41868);
/* harmony import */ var _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(11493);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(28098);
...
var addEdgeMarkers = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((svgPath, edge, url, id, diagramType) => {
...
var addEdgeMarker = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((svgPath, position, arrowType, url, id, diagramType) => {
  const endMarkerType = arrowTypesMap[arrowType];
  if (!endMarkerType) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.warn(`Unknown arrow type: ${arrowType}`);
    return;
  }
...
var clear = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(() => {
  edgeLabels.clear();
  terminalLabels.clear();
}, "clear");
var getLabelStyles = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((styleArray) => {
  let styles = styleArray ? styleArray.reduce((acc, style) => acc + ";" + style, "") : "";
  return styles;
}, "getLabelStyles");
var insertEdgeLabel = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(async (elem, edge) => {
  let useHtmlLabels = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)().flowchart.htmlLabels);
  const labelElement = await (0,_chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_3__/* .createText */ .rw)(elem, edge.label, {
    style: getLabelStyles(edge.labelStyle),
    useHtmlLabels,
    addSvgBackground: true,
    isNode: false
  });
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("abc82", edge, edge.labelType);
  ...
  if (edge.startLabelLeft) {
    const startLabelElement = await (0,_chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .XO)(
      edge.startLabelLeft,
  ...
  if (edge.endLabelLeft) {
    const endLabelElement = await (0,_chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .XO)(edge.endLabelLeft, getLabelStyles(edge.labelStyle));
  ...
  if (edge.endLabelRight) {
    const endLabelElement = await (0,_chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_0__/* .createLabel_default */ .XO)(edge.endLabelRight, getLabelStyles(edge.labelStyle));
...
function setTerminalWidth(fo, value) {
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)().flowchart.htmlLabels && fo) {
    fo.style.width = value.length * 9 + "px";
    fo.style.height = "12px";
  }
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(setTerminalWidth, "setTerminalWidth");
var positionEdgeLabel = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((edge, paths) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("Moving label abc88 ", edge.id, edge.label, edgeLabels.get(edge.id), paths);
  let path = paths.updatedPath ? paths.updatedPath : paths.originalPath;
  const siteConfig = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
  const { subGraphTitleTotalMargin } = (0,_chunk_3X56UNUX_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getSubGraphTitleMargins */ .L)(siteConfig);
  if (edge.label) {
    const el = edgeLabels.get(edge.id);
    let x = edge.x;
    let y = edge.y;
    if (path) {
      const pos = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.calcLabelPosition(path);
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug(
  ...
  if (edge.startLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.calcTerminalLabelPosition(edge.arrowTypeStart ? 10 : 0, "start_left", path);
      x = pos.x;
      y = pos.y;
    }
  ...
  if (edge.startLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.calcTerminalLabelPosition(
  ...
  if (edge.endLabelLeft) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_left", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
  ...
  if (edge.endLabelRight) {
    ...
    let y = edge.y;
    if (path) {
      const pos = _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_4__/* .utils_default */ .w8.calcTerminalLabelPosition(edge.arrowTypeEnd ? 10 : 0, "end_right", path);
      x = pos.x;
      y = pos.y;
    }
    el.attr("transform", `translate(${x}, ${y})`);
...
var outsideNode = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((node, point2) => {
  const x = node.x;
  const y = node.y;
...
var intersection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((node, outsidePoint, insidePoint) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug(`intersection calc abc89:
  ...
  if (Math.abs(y - outsidePoint.y) * w > Math.abs(x - outsidePoint.x) * h) {
    ...
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug(`abc89 top/bottom calc, Q ${Q}, q ${q}, R ${R}, r ${r}`, res);
    return res;
  } else {
    ...
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug(`sides calc abc89, Q ${Q}, q ${q}, R ${R}, r ${r}`, { _x, _y });
    if (r === 0) {
      _x = outsidePoint.x;
      _y = outsidePoint.y;
    }
...
var cutPathAtIntersect = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((_points, boundaryNode) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.warn("abc88 cutPathAtIntersect", _points, boundaryNode);
  let points = [];
  let lastPointOutside = _points[0];
  let isInside = false;
  _points.forEach((point2) => {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("abc88 checking point", point2, boundaryNode);
    if (!outsideNode(boundaryNode, point2) && !isInside) {
      const inter = intersection(boundaryNode, lastPointOutside, point2);
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("abc88 inside", point2, lastPointOutside, inter);
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("abc88 intersection", inter, boundaryNode);
      ...
      if (!points.some((e) => e.x === inter.x && e.y === inter.y)) {
        ...
        _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.warn("abc88 no intersect", inter, points);
      }
      isInside = true;
    } else {
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.warn("abc88 outside", point2, lastPointOutside);
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.debug("returning points", points);
  return points;
}, "cutPathAtIntersect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(extractCornerPoints, "extractCornerPoints");
var findAdjacentPoint = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(pointA, pointB, distance) {
...
var fixCorners = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(lineData) {
...
var insertEdge = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)(function(elem, edge, clusterDb, diagramType, startNode, endNode, id) {
  const { handDrawnSeed } = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)();
  ...
  if (edge.toCluster) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("to cluster abc88", clusterDb.get(edge.toCluster));
  ...
  const { x, y } = (0,_chunk_3JNJP5BE_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getLineFunctionsWithOffset */ .o)(edge);
  ...
  let url = "";
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)().flowchart.arrowMarkerAbsolute || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .nV)().state.arrowMarkerAbsolute) {
    url = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search;
    url = url.replace(/\(/g, "\\(").replace(/\)/g, "\\)");
  }
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("arrowTypeStart", edge.arrowTypeStart);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.info("arrowTypeEnd", edge.arrowTypeEnd);
...
var insertMarkers = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, markerArray, type, id) => {
  markerArray.forEach((markerName) => {
    markers[markerName](elem, type, id);
  });
}, "insertMarkers");
var extension = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .log */ .cM.trace("Making markers for ", id);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionStart").attr("class", "marker extension " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 1,7 L18,13 V 1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-extensionEnd").attr("class", "marker extension " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 1,1 V 13 L18,7 Z");
}, "extension");
var composition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionStart").attr("class", "marker composition " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-compositionEnd").attr("class", "marker composition " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "composition");
var aggregation = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationStart").attr("class", "marker aggregation " + type).attr("refX", 18).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-aggregationEnd").attr("class", "marker aggregation " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L1,7 L9,1 Z");
}, "aggregation");
var dependency = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyStart").attr("class", "marker dependency " + type).attr("refX", 6).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("path").attr("d", "M 5,7 L9,13 L1,7 L9,1 Z");
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-dependencyEnd").attr("class", "marker dependency " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 20).attr("markerHeight", 28).attr("orient", "auto").append("path").attr("d", "M 18,7 L9,13 L14,7 L9,1 Z");
}, "dependency");
var lollipop = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopStart").attr("class", "marker lollipop " + type).attr("refX", 13).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
  elem.append("defs").append("marker").attr("id", id + "_" + type + "-lollipopEnd").attr("class", "marker lollipop " + type).attr("refX", 1).attr("refY", 7).attr("markerWidth", 190).attr("markerHeight", 240).attr("orient", "auto").append("circle").attr("stroke", "black").attr("fill", "transparent").attr("cx", 7).attr("cy", 7).attr("r", 6);
}, "lollipop");
var point = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
...
var circle = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-circleEnd").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", 11).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-circleStart").attr("class", "marker " + type).attr("viewBox", "0 0 10 10").attr("refX", -1).attr("refY", 5).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("circle").attr("cx", "5").attr("cy", "5").attr("r", "5").attr("class", "arrowMarkerPath").style("stroke-width", 1).style("stroke-dasharray", "1,0");
}, "circle");
var cross = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
  elem.append("marker").attr("id", id + "_" + type + "-crossEnd").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", 12).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
  elem.append("marker").attr("id", id + "_" + type + "-crossStart").attr("class", "marker cross " + type).attr("viewBox", "0 0 11 11").attr("refX", -1).attr("refY", 5.2).attr("markerUnits", "userSpaceOnUse").attr("markerWidth", 11).attr("markerHeight", 11).attr("orient", "auto").append("path").attr("d", "M 1,1 l 9,9 M 10,1 l -9,9").attr("class", "arrowMarkerPath").style("stroke-width", 2).style("stroke-dasharray", "1,0");
}, "cross");
var barb = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_5__/* .__name */ .eW)((elem, type, id) => {
...
__webpack_require__.d(__webpack_exports__, {
  ...
  mc: () => (/* binding */ chunk_6DBFFHIP_reset),
...
var dayjs_min = __webpack_require__(59395);
...
;// CONCATENATED MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-6DBFFHIP.mjs
...
var chunk_6DBFFHIP_reset = /* @__PURE__ */ __name((config2 = siteConfig) => {
  directives = [];
...
/* harmony export */ });
/* harmony import */ var _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41868);
/* harmony import */ var _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11493);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28098);
/* harmony import */ var marked__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(43004);
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(preprocessMarkdown, "preprocessMarkdown");
function markdownToLines(markdown, config = {}) {
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(processNode, "processNode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(markdownToLines, "markdownToLines");
function markdownToHTML(markdown, { markdownAutoWrap } = {}) {
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(output, "output");
  return nodes.map(output).join("");
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(markdownToHTML, "markdownToHTML");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(splitTextToChars, "splitTextToChars");
function splitWordToFitWidth(checkFit, word) {
  const characters = splitTextToChars(word.content);
  return splitWordToFitWidthRecursion(checkFit, [], characters, word.type);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(splitWordToFitWidth, "splitWordToFitWidth");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(splitWordToFitWidthRecursion, "splitWordToFitWidthRecursion");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(splitLineToFitWidth, "splitLineToFitWidth");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(splitLineToFitWidthRecursion, "splitLineToFitWidthRecursion");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(applyStyle, "applyStyle");
async function addHtmlSpan(element, node, width, classes, addBackground = false) {
  ...
  if (node.label && (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .hasKatex */ .l0)(node.label)) {
    label = await (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .renderKatex */ .uT)(node.label.replace(_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .common_default */ .SY.lineBreakRegex, "\n"), (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getConfig2 */ .nV)());
  }
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(addHtmlSpan, "addHtmlSpan");
function createTspan(textElement, lineIndex, lineHeight) {
  return textElement.append("tspan").attr("class", "text-outer-tspan").attr("x", 0).attr("y", lineIndex * lineHeight - 0.1 + "em").attr("dy", lineHeight + "em");
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(createTspan, "createTspan");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(computeWidthOfText, "computeWidthOfText");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(computeDimensionOfText, "computeDimensionOfText");
function createFormattedText(width, g, structuredText, addBackground = false) {
  ...
  for (const line of structuredText) {
    const checkWidth = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)((line2) => computeWidthOfText(labelGroup, lineHeight, line2) <= width, "checkWidth");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(createFormattedText, "createFormattedText");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(updateTextContentAndStyles, "updateTextContentAndStyles");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(replaceIconSubstring, "replaceIconSubstring");
var createText = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .__name */ .eW)(async (el, text = "", {
  style = "",
  isTitle = false,
  classes = "",
  useHtmlLabels = true,
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .log */ .cM.debug(
    "XYZ createText",
    text,
    style,
    isTitle,
  ...
  if (useHtmlLabels) {
    ...
    const decodedReplacedText = replaceIconSubstring((0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_0__/* .decodeEntities */ .SH)(htmlText));
    const inputForKatex = text.replace(/\\\\/g, "\\");
    const node = {
      isNode,
      label: (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_1__/* .hasKatex */ .l0)(text) ? inputForKatex : decodedReplacedText,
...
var detectInit = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(text, config) {
  const inits = detectDirective(text, /(?:init\b)|(?:initialize\b)/);
  let results = {};
  if (Array.isArray(inits)) {
    const args = inits.map((init) => init.args);
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .sanitizeDirective */ .NM)(args);
    results = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .assignWithDepth_default */ .Yc)(results, [...args]);
  } else {
    results = inits.args;
  }
  if (!results) {
  ...
  let type = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .detectType */ .Vg)(text, config);
  const prop = "config";
...
var detectDirective = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(text, type = null) {
  try {
...
`,
    ...
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.debug(
      `Detecting diagram directive${type !== null ? " type:" + type : ""} based on the text:${text}`
    );
    let match;
    const result = [];
    while ((match = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .Zn.exec(text)) !== null) {
      if (match.index === _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .Zn.lastIndex) {
        _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .Zn.lastIndex++;
      }
    ...
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.error(
      `ERROR: ${error.message} - Unable to parse directive type: '${type}' based on the text: '${text}'`
    );
    return { type: void 0, args: null };
  }
}, "detectDirective");
var removeDirectives = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(text) {
  return text.replace(_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .directiveRegex */ .Zn, "");
}, "removeDirectives");
var isSubstringInArray = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(str, arr) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(interpolateToCurve, "interpolateToCurve");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(formatUrl, "formatUrl");
var runFunc = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((functionName, ...params) => {
  ...
  for (let i = 0; i < len; i++) {
    obj = obj[arrPaths[i]];
    if (!obj) {
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.error(`Function name: ${functionName} not found in window`);
      return;
    }
  }
  obj[fnName](...params);
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(distance, "distance");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(traverseEdge, "traverseEdge");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(calcLabelPosition, "calcLabelPosition");
var roundNumber = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((num, precision = 2) => {
  const factor = Math.pow(10, precision);
  return Math.round(num * factor) / factor;
}, "roundNumber");
var calculatePoint = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((points, distanceToTraverse) => {
...
var calcCardinalityPosition = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((isRelationTypePresent, points, initialPosition) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.info(`our points ${JSON.stringify(points)}`);
...
function calcTerminalLabelPosition(terminalMarkerSize, position, _points) {
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .log */ .cM.info("our points", points);
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(calcTerminalLabelPosition, "calcTerminalLabelPosition");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getStylesFromArray, "getStylesFromArray");
var cnt = 0;
var generateId = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(() => {
  cnt++;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(makeRandomHex, "makeRandomHex");
var random = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((options) => {
  return makeRandomHex(options.length);
}, "random");
var getTextObj = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
  return {
    x: 0,
    y: 0,
    fill: void 0,
...
var drawSimpleText = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(elem, textData) {
  const nText = textData.text.replace(_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .SY.lineBreakRegex, " ");
...
var wrapLabel = (0,lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(
  (label, maxWidth, config) => {
    ...
    if (_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .SY.lineBreakRegex.test(label)) {
      return label;
    }
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(calculateTextHeight, "calculateTextHeight");
function calculateTextWidth(text, config) {
  return calculateTextDimensions(text, config).width;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(calculateTextWidth, "calculateTextWidth");
var calculateTextDimensions = (0,lodash_es_memoize_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z)(
  (text, config) => {
    ...
    const lines = text.split(_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .common_default */ .SY.lineBreakRegex);
    const dims = [];
...
var InitIDGenerator = class {
  ...
  static {
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(this, "InitIDGenerator");
  }
};
var decoder;
var entityDecode = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(html) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isDetailedError, "isDetailedError");
var insertTitle = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((parent, cssClass, titleTopMargin, title) => {
  if (!title) {
    return;
  }
...
var parseFontSize = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((fontSize) => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(cleanAndMerge, "cleanAndMerge");
var utils_default = {
  assignWithDepth: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .assignWithDepth_default */ .Yc,
  wrapLabel,
  calculateTextHeight,
  calculateTextWidth,
...
var encodeEntities = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(text) {
  let txt = text;
...
var decodeEntities = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(text) {
  return text.replace(/ﬂ°°/g, "&#").replace(/ﬂ°/g, "&").replace(/¶ß/g, ";");
}, "decodeEntities");
var getEdgeId = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((from, to, {
  counter = 0,
  prefix,
  suffix
}) => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(handleUndefinedAttr, "handleUndefinedAttr");
...
/* harmony export */ });
/* harmony import */ var _chunk_OPO4IU42_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22591);
/* harmony import */ var _chunk_3X56UNUX_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22207);
/* harmony import */ var _chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(93084);
/* harmony import */ var _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(41868);
/* harmony import */ var _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(11493);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(28098);
...
var labelHelper = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (parent, node, _classes) => {
  let cssClasses;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()?.htmlLabels);
  if (!_classes) {
  ...
  const labelEl = shapeSvg.insert("g").attr("class", "label").attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(node.labelStyle));
  let label;
  ...
  const text2 = await (0,_chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .rw)(labelEl, (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .oO)((0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .SH)(label), (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()), {
    useHtmlLabels,
    width: node.width || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().flowchart?.wrappingWidth,
        ...
        [...images].map(
          (img) => new Promise((res) => {
            function setupImage() {
              ...
              if (noImgText) {
                const bodyFontSize = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().fontSize ? (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().fontSize : window.getComputedStyle(document.body).fontSize;
                const enlargingFactor = 5;
                const [parsedBodyFontSize = _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .defaultConfig_default */ .vZ.fontSize] = (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .parseFontSize */ .VG)(bodyFontSize);
            ...
            (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(setupImage, "setupImage");
            setTimeout(() => {
              if (img.complete) {
                setupImage();
              }
...
var insertLabel = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (parent, label, options) => {
  const useHtmlLabels = options.useHtmlLabels || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()?.flowchart?.htmlLabels);
  const labelEl = parent.insert("g").attr("class", "label").attr("style", options.labelStyle || "");
  const text2 = await (0,_chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .rw)(labelEl, (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText */ .oO)((0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .SH)(label), (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()), {
    useHtmlLabels,
    width: options.width || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()?.flowchart?.wrappingWidth,
    style: options.labelStyle,
    addSvgBackground: !!options.icon || !!options.img
  });
  let bbox = text2.getBBox();
  const halfPadding = options.padding / 2;
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)()?.flowchart?.htmlLabels)) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ys)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
...
var updateNodeBounds = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node, element) => {
  const bbox = element.node().getBBox();
  node.width = bbox.width;
  node.height = bbox.height;
}, "updateNodeBounds");
var getNodeClasses = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node, extra) => (node.look === "handDrawn" ? "rough-node" : "node") + " " + node.cssClasses + " " + (extra || ""), "getNodeClasses");
function createPathFromPoints(points) {
  const pointStrings = points.map((p, i) => `${i === 0 ? "M" : "L"}${p.x},${p.y}`);
  pointStrings.push("Z");
  return pointStrings.join(" ");
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(createPathFromPoints, "createPathFromPoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateFullSineWavePoints, "generateFullSineWavePoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateCirclePoints, "generateCirclePoints");
...
var intersectRect = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node, point) => {
  var x = node.x;
  var y = node.y;
  var dx = point.x - x;
  var dy = point.y - y;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(applyStyle, "applyStyle");
async function addHtmlLabel(node) {
  ...
  const div = fo.append("xhtml:div");
  let label = node.label;
  if (node.label && (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .l0)(node.label)) {
    label = await (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .renderKatex */ .uT)(node.label.replace(_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .common_default */ .SY.lineBreakRegex, "\n"), (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)());
  }
  const labelClass = node.isNode ? "nodeLabel" : "edgeLabel";
  div.html(
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(addHtmlLabel, "addHtmlLabel");
var createLabel = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (_vertexText, style, isTitle, isNode) => {
  ...
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().flowchart.htmlLabels)) {
    ...
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("vertexText" + vertexText);
    const node = {
      isNode,
      label: (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .SH)(vertexText).replace(
        /fa[blrs]?:fa-[\w-]+/g,
        (s) => `<i class='${s.replace(":", " ")}'></i>`
      ),
...
var createRoundedRectPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, totalWidth, totalHeight, radius) => [
  "M",
  x + radius,
  y,
...
var solidStateFill = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((color) => {
  const { handDrawnSeed } = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  return {
    fill: color,
    hachureAngle: 120,
    // angle of hachure,
...
var compileStyles = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node) => {
  const stylesMap = styles2Map([...node.cssCompiledStyles || [], ...node.cssStyles || []]);
  return { stylesMap, stylesArray: [...stylesMap] };
}, "compileStyles");
var styles2Map = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((styles) => {
...
var styles2String = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node) => {
...
var userNodeOverrides = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node, options) => {
  const { themeVariables, handDrawnSeed } = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
...
// src/rendering-util/rendering-elements/clusters.js
var rect = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (parent, node) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  ...
  const useHtmlLabels = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)(siteConfig.flowchart.htmlLabels);
  const labelEl = shapeSvg.insert("g").attr("class", "cluster-label ");
  const text2 = await (0,_chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .rw)(labelEl, node.label, {
    style: node.labelStyle,
    useHtmlLabels,
    isNode: true
  });
  let bbox = text2.getBBox();
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)(siteConfig.flowchart.htmlLabels)) {
    const div = text2.children[0];
    const dv = (0,d3__WEBPACK_IMPORTED_MODULE_5__/* .select */ .Ys)(text2);
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.trace("Data ", node, JSON.stringify(node));
  let rect2;
  if (node.look === "handDrawn") {
    ...
    rect2 = shapeSvg.insert(() => {
      _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.debug("Rough node insert CXC", roughNode);
      return roughNode;
    }, ":first-child");
  ...
  const { subGraphTitleTopMargin } = (0,_chunk_3X56UNUX_mjs__WEBPACK_IMPORTED_MODULE_1__/* .getSubGraphTitleMargins */ .L)(siteConfig);
  labelEl.attr(
    "transform",
...
var noteGroup = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parent, node) => {
...
var roundedWithTitle = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (parent, node) => {
  const siteConfig = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  ...
  label.attr(
    "transform",
    `translate(${node.x - bbox.width / 2}, ${y + 1 - ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)(siteConfig.flowchart.htmlLabels) ? 0 : 3)})`
  );
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.offsetX = 0;
...
var kanbanSection = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (parent, node) => {
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Creating subgraph rect for ", node.id, node);
  const siteConfig = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  const { themeVariables, handDrawnSeed } = siteConfig;
  const { clusterBkg, clusterBorder } = themeVariables;
...
var divider = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((parent, node) => {
  const siteConfig = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  const { themeVariables, handDrawnSeed } = siteConfig;
...
var insertCluster = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(async (elem, node) => {
  const shape = node.shape || "rect";
  const cluster = await shapes[shape](elem, node);
  clusterElems.set(node.id, cluster);
  return cluster;
}, "insertCluster");
var clear = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(intersectNode, "intersectNode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(intersectEllipse, "intersectEllipse");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(intersectCircle, "intersectCircle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(intersectLine, "intersectLine");
function sameSign(r1, r2) {
  return r1 * r2 > 0;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(sameSign, "sameSign");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(intersectPolygon, "intersectPolygon");
...
function anchor(parent, node) {
  ...
  circleElem.attr("class", "anchor").attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(cssStyles));
  updateNodeBounds(node, circleElem);
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Circle intersect", node, radius, point);
    return intersect_default.circle(node, radius, point);
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(anchor, "anchor");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateArcPoints, "generateArcPoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(bowTieRect, "bowTieRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(insertPolygonShape, "insertPolygonShape");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(card, "card");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(choice, "choice");
...
async function circle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    circleElem.attr("class", "basic label-container").attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(cssStyles));
  } else {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(circle, "circle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(createLine, "createLine");
function crossedCircle(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("crossedCircle intersect", node, { radius, point });
    const pos = intersect_default.circle(node, radius, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(crossedCircle, "crossedCircle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateCirclePoints2, "generateCirclePoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(curlyBraceLeft, "curlyBraceLeft");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateCirclePoints3, "generateCirclePoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(curlyBraceRight, "curlyBraceRight");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(generateCirclePoints4, "generateCirclePoints");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(curlyBraces, "curlyBraces");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(curvedTrapezoid, "curvedTrapezoid");

// src/rendering-util/rendering-elements/shapes/cylinder.ts

var createCylinderPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
...
var createOuterCylinderPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
...
async function cylinder(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    cylinder2 = shapeSvg.insert("path", ":first-child").attr("d", pathData).attr("class", "basic label-container").attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(cssStyles)).attr("style", nodeStyles);
  }
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(cylinder, "cylinder");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(dividedRectangle, "dividedRectangle");
...
async function doublecircle(parent, node) {
  ...
  if (node.look === "handDrawn") {
    ...
    circleGroup.attr("class", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(node.cssClasses)).attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(cssStyles));
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("DoubleCircle intersect", node, outerRadius, point);
    return intersect_default.circle(node, outerRadius, point);
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(doublecircle, "doublecircle");
...
function filledCircle(parent, node, { config: { themeVariables } }) {
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("filledCircle intersect", node, { radius, point });
    const pos = intersect_default.circle(node, radius, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(filledCircle, "filledCircle");
...
async function flippedTriangle(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Triangle intersect", node, points, point);
    return intersect_default.polygon(node, points, point);
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(flippedTriangle, "flippedTriangle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(forkJoin, "forkJoin");
...
async function halfRoundedRectangle(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Pill intersect", node, { radius, point });
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(halfRoundedRectangle, "halfRoundedRectangle");

// src/rendering-util/rendering-elements/shapes/hexagon.ts

var createHexagonPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, m) => {
  return [
    `M${x + m},${y}`,
    `L${x + width - m},${y}`,
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(hexagon, "hexagon");
...
async function hourglass(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Pill intersect", node, { points });
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(hourglass, "hourglass");
...
async function icon(parent, node, { config: { themeVariables, flowchart } }) {
  ...
  if (node.icon) {
    ...
    iconElem.html(
      `<g>${await (0,_chunk_OPO4IU42_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getIconSVG */ .s4)(node.icon, {
        height: iconSize,
        width: iconSize,
        fallbackPrefix: ""
      })}</g>`
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("iconSquare intersect", node, point);
    if (!node.label) {
      return intersect_default.rect(node, point);
    }
    const dx = node.x ?? 0;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(icon, "icon");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(iconCircle, "iconCircle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(iconRounded, "iconRounded");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(iconSquare, "iconSquare");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(imageSquare, "imageSquare");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(inv_trapezoid, "inv_trapezoid");
...
async function drawRect(parent, node, options) {
  ...
  if (node.look === "handDrawn") {
    ...
    rect2.attr("class", "basic label-container").attr("style", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(cssStyles));
  } else {
    rect2 = shapeSvg.insert("rect", ":first-child");
    rect2.attr("class", "basic label-container").attr("style", nodeStyles).attr("rx", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(rx)).attr("ry", (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .handleUndefinedAttr */ .R7)(ry)).attr("x", x).attr("y", y).attr("width", totalWidth).attr("height", totalHeight);
  }
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(drawRect, "drawRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(labelRect, "labelRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(lean_left, "lean_left");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(lean_right, "lean_right");
...
function lightningBolt(parent, node) {
  ...
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("lightningBolt intersect", node, point);
    const pos = intersect_default.polygon(node, points, point);
    return pos;
  };
  return shapeSvg;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(lightningBolt, "lightningBolt");

// src/rendering-util/rendering-elements/shapes/linedCylinder.ts

var createCylinderPathD2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${width},0`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createOuterCylinderPathD2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry, outerOffset) => {
  return [
    `M${x},${y + ry}`,
    `M${x + width},${y + ry}`,
    `a${rx},${ry} 0,0,0 ${-width},0`,
...
var createInnerCylinderPathD2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
  return [`M${x - width / 2},${-height / 2}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createInnerCylinderPathD");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(linedCylinder, "linedCylinder");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(linedWaveEdgedRect, "linedWaveEdgedRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(multiRect, "multiRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(multiWaveEdgedRectangle, "multiWaveEdgedRectangle");
...
async function note(parent, node, { config: { themeVariables } }) {
  const { labelStyles, nodeStyles } = styles2String(node);
  node.labelStyle = labelStyles;
  const useHtmlLabels = node.useHtmlLabels || (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .iE)().flowchart?.htmlLabels !== false;
  if (!useHtmlLabels) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(note, "note");

// src/rendering-util/rendering-elements/shapes/question.ts

var createDecisionBoxPathD = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, size) => {
  return [
    `M${x + size / 2},${y}`,
    `L${x + size},${y - size / 2}`,
    `L${x + size / 2},${y - size}`,
...
async function question(parent, node) {
  ...
  updateNodeBounds(node, polygon);
  node.intersect = function(point) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.debug(
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(question, "question");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(rect_left_inv_arrow, "rect_left_inv_arrow");
...
async function rectWithTitle(parent, node) {
  ...
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.info("Text 2", description);
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(rectWithTitle, "rectWithTitle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(roundedRect, "roundedRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(shadedProcess, "shadedProcess");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(slopedRect, "slopedRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(squareRect2, "squareRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(stadium, "stadium");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(state, "state");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(stateEnd, "stateEnd");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(stateStart, "stateStart");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(subroutine, "subroutine");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(taggedRect, "taggedRect");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(taggedWaveEdgedRectangle, "taggedWaveEdgedRectangle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(text, "text");

// src/rendering-util/rendering-elements/shapes/tiltedCylinder.ts

var createCylinderPathD3 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
  return `M${x},${y}
...
var createOuterCylinderPathD3 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
  return [
    `M${x},${y}`,
    `M${x + width},${y}`,
    `a${rx},${ry} 0,0,0 ${0},${-height}`,
...
var createInnerCylinderPathD3 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((x, y, width, height, rx, ry) => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(tiltedCylinder, "tiltedCylinder");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(trapezoid, "trapezoid");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(trapezoidalPentagon, "trapezoidalPentagon");
...
async function triangle(parent, node) {
  ...
  node.labelStyle = labelStyles;
  const { shapeSvg, bbox, label } = await labelHelper(parent, node, getNodeClasses(node));
  const useHtmlLabels = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)().flowchart?.htmlLabels);
  const w = bbox.width + (node.padding ?? 0);
  const h = w + bbox.height;
  const tw = w + bbox.height;
  const points = [
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(triangle, "triangle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(waveEdgedRectangle, "waveEdgedRectangle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(waveRectangle, "waveRectangle");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(windowPane, "windowPane");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(textHelper, "textHelper");
async function addText(parentGroup, node, yOffset, styles = []) {
  const textEl = parentGroup.insert("g").attr("class", "label").attr("style", styles.join("; "));
  const config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig */ .iE)();
  let useHtmlLabels = "useHtmlLabels" in node ? node.useHtmlLabels : (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)(config.htmlLabels) ?? true;
  let textContent = "";
  if ("text" in node) {
  ...
  if ((0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .hasKatex */ .l0)(textContent)) {
    useHtmlLabels = true;
  }
  const text2 = await (0,_chunk_6JOS74DS_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .rw)(
    textEl,
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .sanitizeText2 */ .uX)((0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .decodeEntities */ .SH)(textContent)),
    {
      width: (0,_chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_3__/* .calculateTextWidth */ .Cq)(textContent, config) + 50,
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(addText, "addText");

// src/rendering-util/rendering-elements/shapes/classBox.ts
async function classBox(parent, node) {
  const config = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getConfig2 */ .nV)();
  const PADDING = config.class.padding ?? 12;
  const GAP = PADDING;
  const useHtmlLabels = node.useHtmlLabels ?? (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .evaluate */ .ku)(config.htmlLabels) ?? true;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(classBox, "classBox");

// src/rendering-util/rendering-elements/shapes/kanbanItem.ts

var colorFromPriority = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((priority) => {
  switch (priority) {
    case "Very High":
      return "red";
    case "High":
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(kanbanItem, "kanbanItem");
...
var generateShapeMap = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(isValidShape, "isValidShape");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(insertNode, "insertNode");
var setNodeElem = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((elem, node) => {
  nodeElems.set(node.id, elem);
}, "setNodeElem");
var clear2 = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)(() => {
  nodeElems.clear();
}, "clear");
var positionNode = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .eW)((node) => {
  const el = nodeElems.get(node.id);
  _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_4__/* .log */ .cM.trace(
    "Transforming node",
    node.diff,
    node,
...
// src/internals.ts
var internalHelpers = {
  common: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .common_default */ .SY,
  getConfig: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .iE,
  insertCluster: _chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertCluster */ .us,
  insertEdge: _chunk_66SQ7PYY_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdge */ .QP,
  insertEdgeLabel: _chunk_66SQ7PYY_mjs__WEBPACK_IMPORTED_MODULE_0__/* .insertEdgeLabel */ .I_,
  insertMarkers: _chunk_66SQ7PYY_mjs__WEBPACK_IMPORTED_MODULE_0__/* .markers_default */ .DQ,
  insertNode: _chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_1__/* .insertNode */ .Lf,
  interpolateToCurve: _chunk_7DKRZKHE_mjs__WEBPACK_IMPORTED_MODULE_2__/* .interpolateToCurve */ .le,
  labelHelper: _chunk_7NZE2EM7_mjs__WEBPACK_IMPORTED_MODULE_1__/* .labelHelper */ .C1,
  log: _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM,
  positionEdgeLabel: _chunk_66SQ7PYY_mjs__WEBPACK_IMPORTED_MODULE_0__/* .positionEdgeLabel */ .Jj
};

// src/rendering-util/render.ts
var layoutAlgorithms = {};
var registerLayoutLoaders = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((loaders) => {
  for (const loader of loaders) {
    layoutAlgorithms[loader.name] = loader;
  }
}, "registerLayoutLoaders");
var registerDefaultLayoutLoaders = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(async () => await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(4276), __webpack_require__.e(9294)]).then(__webpack_require__.bind(__webpack_require__, 29294)), "loader")
    }
  ]);
}, "registerDefaultLayoutLoaders");
registerDefaultLayoutLoaders();
var render = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)(async (data4Layout, svg) => {
...
var getRegisteredLayoutAlgorithm = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .__name */ .eW)((algorithm = "", { fallback = "dagre" } = {}) => {
  if (algorithm in layoutAlgorithms) {
    return algorithm;
  }
  if (fallback in layoutAlgorithms) {
    _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_3__/* .log */ .cM.warn(`Layout algorithm ${algorithm} is not registered. Using ${fallback} as fallback.`);
    return fallback;
  }
...
/* harmony export */ });
/* harmony import */ var _chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11493);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28098);


// src/rendering-util/selectSvgElement.ts

var selectSvgElement = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)((id) => {
  const { securityLevel } = (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .getConfig2 */ .nV)();
...
var chunk_6DBFFHIP = __webpack_require__(11493);
...
;// CONCATENATED MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-OPO4IU42.mjs
...
var registerIconPacks = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((iconLoaders) => {
  for (const iconLoader of iconLoaders) {
    ...
    chunk_6DBFFHIP/* log */.cM.debug("Registering icon pack:", iconLoader.name);
    if ("loader" in iconLoader) {
      loaderStore.set(iconLoader.name, iconLoader.loader);
    } else if ("icons" in iconLoader) {
      iconsStore.set(iconLoader.name, iconLoader.icons);
    } else {
      chunk_6DBFFHIP/* log */.cM.error("Invalid icon loader:", iconLoader);
      throw new Error('Invalid icon loader. Must have either "icons" or "loader" property.');
    }
  }
}, "registerIconPacks");
var getRegisteredIconData = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async (iconName, fallbackPrefix) => {
...
var getIconSVG = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async (iconName, customisations) => {
  let iconData;
  try {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isNothing, "isNothing");
function isObject(subject) {
  return typeof subject === "object" && subject !== null;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isObject, "isObject");
function toArray(sequence) {
  if (Array.isArray(sequence)) return sequence;
  else if (isNothing(sequence)) return [];
  return [sequence];
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(toArray, "toArray");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(extend, "extend");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(repeat, "repeat");
function isNegativeZero(number) {
  return number === 0 && Number.NEGATIVE_INFINITY === 1 / number;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isNegativeZero, "isNegativeZero");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(formatError, "formatError");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(YAMLException$1, "YAMLException$1");
YAMLException$1.prototype = Object.create(Error.prototype);
YAMLException$1.prototype.constructor = YAMLException$1;
YAMLException$1.prototype.toString = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function toString(compact) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getLine, "getLine");
function padStart(string, max) {
  return common.repeat(" ", max - string.length) + string;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(padStart, "padStart");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(makeSnippet, "makeSnippet");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(compileStyleAliases, "compileStyleAliases");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(Type$1, "Type$1");
var type = Type$1;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(compileList, "compileList");
function compileMap() {
  var result = {
    scalar: {},
    sequence: {},
  ...
  (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(collectType, "collectType");
  for (index = 0, length = arguments.length; index < length; index += 1) {
    arguments[index].forEach(collectType);
  }
  return result;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(compileMap, "compileMap");
function Schema$1(definition) {
  return this.extend(definition);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(Schema$1, "Schema$1");
Schema$1.prototype.extend = /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function extend2(definition) {
  var implicit = [];
  var explicit = [];
...
var str = new type("tag:yaml.org,2002:str", {
  kind: "scalar",
  construct: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(data) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlNull, "resolveYamlNull");
function constructYamlNull() {
  return null;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlNull, "constructYamlNull");
function isNull(object) {
  return object === null;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isNull, "isNull");
var _null = new type("tag:yaml.org,2002:null", {
  ...
  predicate: isNull,
  represent: {
    canonical: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      return "~";
    }, "canonical"),
    lowercase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      return "null";
    }, "lowercase"),
    uppercase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      return "NULL";
    }, "uppercase"),
    camelcase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      return "Null";
    }, "camelcase"),
    empty: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function() {
      return "";
    }, "empty")
  },
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlBoolean, "resolveYamlBoolean");
function constructYamlBoolean(data) {
  return data === "true" || data === "True" || data === "TRUE";
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlBoolean, "constructYamlBoolean");
function isBoolean(object) {
  return Object.prototype.toString.call(object) === "[object Boolean]";
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isBoolean, "isBoolean");
var bool = new type("tag:yaml.org,2002:bool", {
  ...
  predicate: isBoolean,
  represent: {
    lowercase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(object) {
      return object ? "true" : "false";
    }, "lowercase"),
    uppercase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(object) {
      return object ? "TRUE" : "FALSE";
    }, "uppercase"),
    camelcase: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(object) {
      return object ? "True" : "False";
    }, "camelcase")
  },
  defaultStyle: "lowercase"
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isHexCode, "isHexCode");
function isOctCode(c) {
  return 48 <= c && c <= 55;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isOctCode, "isOctCode");
function isDecCode(c) {
  return 48 <= c && c <= 57;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isDecCode, "isDecCode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlInteger, "resolveYamlInteger");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlInteger, "constructYamlInteger");
function isInteger(object) {
  return Object.prototype.toString.call(object) === "[object Number]" && (object % 1 === 0 && !common.isNegativeZero(object));
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isInteger, "isInteger");
var int = new type("tag:yaml.org,2002:int", {
  ...
  predicate: isInteger,
  represent: {
    binary: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(obj) {
      return obj >= 0 ? "0b" + obj.toString(2) : "-0b" + obj.toString(2).slice(1);
    }, "binary"),
    octal: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(obj) {
      return obj >= 0 ? "0o" + obj.toString(8) : "-0o" + obj.toString(8).slice(1);
    }, "octal"),
    decimal: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(obj) {
      return obj.toString(10);
    }, "decimal"),
    /* eslint-disable max-len */
    hexadecimal: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function(obj) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlFloat, "resolveYamlFloat");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlFloat, "constructYamlFloat");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(representYamlFloat, "representYamlFloat");
function isFloat(object) {
  return Object.prototype.toString.call(object) === "[object Number]" && (object % 1 !== 0 || common.isNegativeZero(object));
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isFloat, "isFloat");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlTimestamp, "resolveYamlTimestamp");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlTimestamp, "constructYamlTimestamp");
function representYamlTimestamp(object) {
  return object.toISOString();
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(representYamlTimestamp, "representYamlTimestamp");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlMerge, "resolveYamlMerge");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlBinary, "resolveYamlBinary");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlBinary, "constructYamlBinary");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(representYamlBinary, "representYamlBinary");
function isBinary(obj) {
  return Object.prototype.toString.call(obj) === "[object Uint8Array]";
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isBinary, "isBinary");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlOmap, "resolveYamlOmap");
function constructYamlOmap(data) {
  return data !== null ? data : [];
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlOmap, "constructYamlOmap");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlPairs, "resolveYamlPairs");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlPairs, "constructYamlPairs");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(resolveYamlSet, "resolveYamlSet");
function constructYamlSet(data) {
  return data !== null ? data : {};
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(constructYamlSet, "constructYamlSet");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(_class, "_class");
function is_EOL(c) {
  return c === 10 || c === 13;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(is_EOL, "is_EOL");
function is_WHITE_SPACE(c) {
  return c === 9 || c === 32;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(is_WHITE_SPACE, "is_WHITE_SPACE");
function is_WS_OR_EOL(c) {
  return c === 9 || c === 32 || c === 10 || c === 13;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(is_WS_OR_EOL, "is_WS_OR_EOL");
function is_FLOW_INDICATOR(c) {
  return c === 44 || c === 91 || c === 93 || c === 123 || c === 125;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(is_FLOW_INDICATOR, "is_FLOW_INDICATOR");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(fromHexCode, "fromHexCode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(escapedHexLen, "escapedHexLen");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(fromDecimalCode, "fromDecimalCode");
function simpleEscapeSequence(c) {
  return c === 48 ? "\0" : c === 97 ? "\x07" : c === 98 ? "\b" : c === 116 ? "	" : c === 9 ? "	" : c === 110 ? "\n" : c === 118 ? "\v" : c === 102 ? "\f" : c === 114 ? "\r" : c === 101 ? "\x1B" : c === 32 ? " " : c === 34 ? '"' : c === 47 ? "/" : c === 92 ? "\\" : c === 78 ? "\x85" : c === 95 ? "\xA0" : c === 76 ? "\u2028" : c === 80 ? "\u2029" : "";
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(simpleEscapeSequence, "simpleEscapeSequence");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(charFromCodepoint, "charFromCodepoint");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(State$1, "State$1");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(generateError, "generateError");
function throwError(state, message) {
  throw generateError(state, message);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(throwError, "throwError");
function throwWarning(state, message) {
  if (state.onWarning) {
    state.onWarning.call(null, generateError(state, message));
  }
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(throwWarning, "throwWarning");
var directiveHandlers = {
  YAML: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function handleYamlDirective(state, name, args) {
  ...
  TAG: /* @__PURE__ */ (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(function handleTagDirective(state, name, args) {
    var handle, prefix;
    if (args.length !== 2) {
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(captureSegment, "captureSegment");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(mergeMappings, "mergeMappings");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(storeMappingPair, "storeMappingPair");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readLineBreak, "readLineBreak");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(skipSeparationSpace, "skipSeparationSpace");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(testDocumentSeparator, "testDocumentSeparator");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeFoldedLines, "writeFoldedLines");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readPlainScalar, "readPlainScalar");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readSingleQuotedScalar, "readSingleQuotedScalar");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readDoubleQuotedScalar, "readDoubleQuotedScalar");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readFlowCollection, "readFlowCollection");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readBlockScalar, "readBlockScalar");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readBlockSequence, "readBlockSequence");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readBlockMapping, "readBlockMapping");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readTagProperty, "readTagProperty");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readAnchorProperty, "readAnchorProperty");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readAlias, "readAlias");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(composeNode, "composeNode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(readDocument, "readDocument");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(loadDocuments, "loadDocuments");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(loadAll$1, "loadAll$1");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(load$1, "load$1");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(compileStyleMap, "compileStyleMap");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(encodeHex, "encodeHex");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(State, "State");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(indentString, "indentString");
function generateNextLine(state, level) {
  return "\n" + common.repeat(" ", state.indent * level);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(generateNextLine, "generateNextLine");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(testImplicitResolving, "testImplicitResolving");
function isWhitespace(c) {
  return c === CHAR_SPACE || c === CHAR_TAB;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isWhitespace, "isWhitespace");
function isPrintable(c) {
  return 32 <= c && c <= 126 || 161 <= c && c <= 55295 && c !== 8232 && c !== 8233 || 57344 <= c && c <= 65533 && c !== CHAR_BOM || 65536 <= c && c <= 1114111;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isPrintable, "isPrintable");
function isNsCharOrWhitespace(c) {
  return isPrintable(c) && c !== CHAR_BOM && c !== CHAR_CARRIAGE_RETURN && c !== CHAR_LINE_FEED;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isNsCharOrWhitespace, "isNsCharOrWhitespace");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isPlainSafe, "isPlainSafe");
function isPlainSafeFirst(c) {
  return isPrintable(c) && c !== CHAR_BOM && !isWhitespace(c) && c !== CHAR_MINUS && c !== CHAR_QUESTION && c !== CHAR_COLON && c !== CHAR_COMMA && c !== CHAR_LEFT_SQUARE_BRACKET && c !== CHAR_RIGHT_SQUARE_BRACKET && c !== CHAR_LEFT_CURLY_BRACKET && c !== CHAR_RIGHT_CURLY_BRACKET && c !== CHAR_SHARP && c !== CHAR_AMPERSAND && c !== CHAR_ASTERISK && c !== CHAR_EXCLAMATION && c !== CHAR_VERTICAL_LINE && c !== CHAR_EQUALS && c !== CHAR_GREATER_THAN && c !== CHAR_SINGLE_QUOTE && c !== CHAR_DOUBLE_QUOTE && c !== CHAR_PERCENT && c !== CHAR_COMMERCIAL_AT && c !== CHAR_GRAVE_ACCENT;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isPlainSafeFirst, "isPlainSafeFirst");
function isPlainSafeLast(c) {
  return !isWhitespace(c) && c !== CHAR_COLON;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(isPlainSafeLast, "isPlainSafeLast");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(codePointAt, "codePointAt");
function needIndentIndicator(string) {
  var leadingSpaceRe = /^\n* /;
  return leadingSpaceRe.test(string);
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(needIndentIndicator, "needIndentIndicator");
var STYLE_PLAIN = 1;
var STYLE_SINGLE = 2;
var STYLE_LITERAL = 3;
var STYLE_FOLDED = 4;
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(chooseScalarStyle, "chooseScalarStyle");
function writeScalar(state, string, level, iskey, inblock) {
  state.dump = function() {
    ...
    (0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(testAmbiguity, "testAmbiguity");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeScalar, "writeScalar");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(blockHeader, "blockHeader");
function dropEndingNewline(string) {
  return string[string.length - 1] === "\n" ? string.slice(0, -1) : string;
}
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(dropEndingNewline, "dropEndingNewline");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(foldString, "foldString");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(foldLine, "foldLine");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(escapeString, "escapeString");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeFlowSequence, "writeFlowSequence");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeBlockSequence, "writeBlockSequence");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeFlowMapping, "writeFlowMapping");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeBlockMapping, "writeBlockMapping");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(detectType, "detectType");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(writeNode, "writeNode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(getDuplicateReferences, "getDuplicateReferences");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(inspectNode, "inspectNode");
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(dump$1, "dump$1");
var dump_1 = dump$1;
var dumper = {
  dump: dump_1
};
...
(0,_chunk_6DBFFHIP_mjs__WEBPACK_IMPORTED_MODULE_0__/* .__name */ .eW)(renamed, "renamed");
...
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-S3SWNSAA.mjs
var chunk_S3SWNSAA = __webpack_require__(64614);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-BO7VGL7K.mjs
var chunk_BO7VGL7K = __webpack_require__(33738);
...
var chunk_3JNJP5BE = __webpack_require__(37683);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-3X56UNUX.mjs
var chunk_3X56UNUX = __webpack_require__(22207);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-6JOS74DS.mjs
var chunk_6JOS74DS = __webpack_require__(93084);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-7DKRZKHE.mjs
var chunk_7DKRZKHE = __webpack_require__(41868);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-K6PMAZHR.mjs
var chunk_K6PMAZHR = __webpack_require__(39811);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-EJ4ZWXGL.mjs
var chunk_EJ4ZWXGL = __webpack_require__(74762);
// EXTERNAL MODULE: ../node_modules/mermaid/dist/chunks/mermaid.core/chunk-6DBFFHIP.mjs + 3 modules
var chunk_6DBFFHIP = __webpack_require__(11493);
// EXTERNAL MODULE: ../node_modules/ts-dedent/esm/index.js
var esm = __webpack_require__(11464);
// EXTERNAL MODULE: ../node_modules/d3/src/index.js + 98 modules
var src = __webpack_require__(28098);
...
var id = "c4";
var detector = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*C4Context|C4Container|C4Component|C4Dynamic|C4Deployment/.test(txt);
}, "detector");
var loader = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 7830).then(__webpack_require__.bind(__webpack_require__, 67830));
...
var id2 = "flowchart";
var detector2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
  if (config?.flowchart?.defaultRenderer === "dagre-wrapper" || config?.flowchart?.defaultRenderer === "elk") {
    return false;
  }
  return /^\s*graph/.test(txt);
}, "detector");
var loader2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 654).then(__webpack_require__.bind(__webpack_require__, 60654));
...
var detector3 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
...
var loader3 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 654).then(__webpack_require__.bind(__webpack_require__, 60654));
...
var id4 = "er";
var detector4 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
...
var id5 = "gitGraph";
var detector5 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*gitGraph/.test(txt);
}, "detector");
var loader5 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3197), __webpack_require__.e(8997)]).then(__webpack_require__.bind(__webpack_require__, 18997));
...
var id6 = "gantt";
var detector6 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*gantt/.test(txt);
}, "detector");
var loader6 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 9273).then(__webpack_require__.bind(__webpack_require__, 59273));
...
var id7 = "info";
var detector7 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*info/.test(txt);
}, "detector");
var loader7 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3197), __webpack_require__.e(319)]).then(__webpack_require__.bind(__webpack_require__, 90319));
...
var id8 = "pie";
var detector8 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*pie/.test(txt);
}, "detector");
var loader8 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3197), __webpack_require__.e(3352)]).then(__webpack_require__.bind(__webpack_require__, 13352));
...
var detector9 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*quadrantChart/.test(txt);
}, "detector");
var loader9 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4004).then(__webpack_require__.bind(__webpack_require__, 34004));
...
var id10 = "xychart";
var detector10 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*xychart-beta/.test(txt);
}, "detector");
var loader10 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4097).then(__webpack_require__.bind(__webpack_require__, 64097));
...
var detector11 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*requirement(Diagram)?/.test(txt);
}, "detector");
var loader11 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(4276), __webpack_require__.e(1985)]).then(__webpack_require__.bind(__webpack_require__, 91985));
...
var id12 = "sequence";
var detector12 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*sequenceDiagram/.test(txt);
}, "detector");
var loader12 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 4215).then(__webpack_require__.bind(__webpack_require__, 64215));
...
var id13 = "class";
var detector13 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
  if (config?.class?.defaultRenderer === "dagre-wrapper") {
    return false;
  }
  return /^\s*classDiagram/.test(txt);
}, "detector");
var loader13 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(9386), __webpack_require__.e(1961)]).then(__webpack_require__.bind(__webpack_require__, 11961));
...
var detector14 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
  if (/^\s*classDiagram/.test(txt) && config?.class?.defaultRenderer === "dagre-wrapper") {
    return true;
  }
  return /^\s*classDiagram-v2/.test(txt);
}, "detector");
var loader14 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(9386), __webpack_require__.e(3384)]).then(__webpack_require__.bind(__webpack_require__, 73384));
...
var id15 = "state";
var detector15 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
  if (config?.state?.defaultRenderer === "dagre-wrapper") {
    return false;
  }
  return /^\s*stateDiagram/.test(txt);
}, "detector");
var loader15 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(4276), __webpack_require__.e(356), __webpack_require__.e(9945)]).then(__webpack_require__.bind(__webpack_require__, 59945));
...
var detector16 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config) => {
...
var loader16 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(356), __webpack_require__.e(9343)]).then(__webpack_require__.bind(__webpack_require__, 49343));
...
var id17 = "journey";
var detector17 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*journey/.test(txt);
}, "detector");
var loader17 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 438).then(__webpack_require__.bind(__webpack_require__, 40438));
...
var draw = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((_text, id26, version2) => {
  chunk_6DBFFHIP/* log */.cM.debug("rendering svg for syntax error\n");
  const svg = (0,chunk_EJ4ZWXGL/* selectSvgElement */.P)(id26);
  const g = svg.append("g");
  svg.attr("viewBox", "0 0 2412 512");
  (0,chunk_6DBFFHIP/* configureSvgSize */.v2)(svg, 100, 512, true);
...
var diagram = {
  ...
  renderer,
  parser: {
    parse: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
      return;
    }, "parse")
  }
};
...
var detector18 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt, config = {}) => {
  if (
...
var loader18 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 654).then(__webpack_require__.bind(__webpack_require__, 60654));
...
var id19 = "timeline";
var detector19 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*timeline/.test(txt);
}, "detector");
var loader19 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 3304).then(__webpack_require__.bind(__webpack_require__, 63304));
...
var id20 = "mindmap";
var detector20 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*mindmap/.test(txt);
}, "detector");
var loader20 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(3207), __webpack_require__.e(726)]).then(__webpack_require__.bind(__webpack_require__, 80726));
...
var id21 = "kanban";
var detector21 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
...
var id22 = "sankey";
var detector22 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*sankey-beta/.test(txt);
}, "detector");
var loader22 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await __webpack_require__.e(/* import() */ 2544).then(__webpack_require__.bind(__webpack_require__, 52544));
...
var id23 = "packet";
var detector23 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*packet-beta/.test(txt);
}, "detector");
var loader23 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3197), __webpack_require__.e(4857)]).then(__webpack_require__.bind(__webpack_require__, 44857));
...
var id24 = "block";
var detector24 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*block-beta/.test(txt);
}, "detector");
var loader24 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3801)]).then(__webpack_require__.bind(__webpack_require__, 3801));
...
var detector25 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((txt) => {
  return /^\s*architecture/.test(txt);
}, "detector");
var loader25 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  const { diagram: diagram2 } = await Promise.all(/* import() */[__webpack_require__.e(2228), __webpack_require__.e(3197), __webpack_require__.e(3207), __webpack_require__.e(2522)]).then(__webpack_require__.bind(__webpack_require__, 72522));
...
var addDiagrams = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
  if (hasLoadedDiagrams) {
    return;
  }
  hasLoadedDiagrams = true;
  (0,chunk_6DBFFHIP/* registerDiagram */.Cq)("error", errorDiagram_default, (text) => {
    return text.toLowerCase().trim() === "error";
  });
  (0,chunk_6DBFFHIP/* registerDiagram */.Cq)(
    "---",
    // --- diagram type may appear if YAML front-matter is not parsed correctly
    {
      db: {
        clear: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
        }, "clear")
      },
      styles: {},
      // should never be used
      renderer: {
        draw: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
        }, "draw")
      },
      parser: {
        parse: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
      ...
      init: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => null, "init")
      // no op
    },
    (text) => {
  ...
  (0,chunk_6DBFFHIP/* registerLazyLoadedDiagrams */.KO)(
    c4Detector_default,
    detector_default4,
...
var loadRegisteredDiagrams = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  chunk_6DBFFHIP/* log */.cM.debug(`Loading registered diagrams`);
  const results = await Promise.allSettled(
    Object.entries(chunk_6DBFFHIP/* detectors */.Bf).map(async ([key, { detector: detector26, loader: loader26 }]) => {
      if (loader26) {
        try {
          (0,chunk_6DBFFHIP/* getDiagram */._7)(key);
        } catch {
          try {
            const { diagram: diagram2, id: id26 } = await loader26();
            (0,chunk_6DBFFHIP/* registerDiagram */.Cq)(id26, diagram2, detector26);
          } catch (err) {
            chunk_6DBFFHIP/* log */.cM.error(`Failed to load external diagram with key ${key}. Removing from detectors.`);
            delete chunk_6DBFFHIP/* detectors */.Bf[key];
            throw err;
          }
        }
      }
  ...
  if (failed.length > 0) {
    chunk_6DBFFHIP/* log */.cM.error(`Failed to load ${failed.length} external diagrams`);
    for (const res of failed) {
      chunk_6DBFFHIP/* log */.cM.error(res);
    }
...
(0,chunk_6DBFFHIP/* __name */.eW)(setA11yDiagramInfo, "setA11yDiagramInfo");
...
(0,chunk_6DBFFHIP/* __name */.eW)(addSVGa11yTitleDescription, "addSVGa11yTitleDescription");
...
var Diagram = class _Diagram {
  ...
  static {
    (0,chunk_6DBFFHIP/* __name */.eW)(this, "Diagram");
  }
  static async fromText(text, metadata = {}) {
    const config = (0,chunk_6DBFFHIP/* getConfig */.iE)();
    const type = (0,chunk_6DBFFHIP/* detectType */.Vg)(text, config);
    text = (0,chunk_7DKRZKHE/* encodeEntities */.Vy)(text) + "\n";
    try {
      (0,chunk_6DBFFHIP/* getDiagram */._7)(type);
    } catch {
      const loader26 = (0,chunk_6DBFFHIP/* getDiagramLoader */.cq)(type);
      if (!loader26) {
        throw new chunk_6DBFFHIP/* UnknownDiagramError */.cj(`Diagram ${type} not found.`);
      }
      const { id: id26, diagram: diagram2 } = await loader26();
      (0,chunk_6DBFFHIP/* registerDiagram */.Cq)(id26, diagram2);
    }
    const { db, parser, renderer: renderer2, init: init2 } = (0,chunk_6DBFFHIP/* getDiagram */._7)(type);
    if (parser.parser) {
      parser.parser.yy = db;
    }
    db.clear?.();
...
var attachFunctions = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
...
var cleanupComments = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((text) => {
  return text.replace(/^\s*%%(?!{)[^\n]+\n?/gm, "").trimStart();
}, "cleanupComments");

// src/diagram-api/frontmatter.ts
function extractFrontMatter(text) {
  const matches = text.match(chunk_6DBFFHIP/* frontMatterRegex */.M6);
  if (!matches) {
    return {
      text,
      metadata: {}
  ...
  let parsed = (0,chunk_S3SWNSAA/* load */.z)(matches[1], {
    // To support config, we need JSON schema.
    // https://www.yaml.org/spec/1.2/spec.html#id2803231
    schema: chunk_S3SWNSAA/* JSON_SCHEMA */.A
  }) ?? {};
...
(0,chunk_6DBFFHIP/* __name */.eW)(extractFrontMatter, "extractFrontMatter");

// src/preprocess.ts
var cleanupText = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((code) => {
  return code.replace(/\r\n?/g, "\n").replace(
    /<(\w+)([^>]*)>/g,
    (match, tag, attributes) => "<" + tag + attributes.replace(/="([^"]*)"/g, "='$1'") + ">"
  );
}, "cleanupText");
var processFrontmatter = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((code) => {
...
var processDirectives = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((code) => {
  const initDirective = chunk_7DKRZKHE/* utils_default */.w8.detectInit(code) ?? {};
  const wrapDirectives = chunk_7DKRZKHE/* utils_default */.w8.detectDirective(code, "wrap");
  ...
  return {
    text: (0,chunk_7DKRZKHE/* removeDirectives */.tf)(code),
...
function preprocessDiagram(code) {
  ...
  const config = (0,chunk_7DKRZKHE/* cleanAndMerge */.Rb)(frontMatterResult.config, directiveResult.directive);
...
(0,chunk_6DBFFHIP/* __name */.eW)(preprocessDiagram, "preprocessDiagram");
...
(0,chunk_6DBFFHIP/* __name */.eW)(toBase64, "toBase64");
...
function processAndSetConfigs(text) {
  ...
  (0,chunk_6DBFFHIP/* reset */.mc)();
  (0,chunk_6DBFFHIP/* addDirective */.XV)(processed.config ?? {});
  return processed;
}
(0,chunk_6DBFFHIP/* __name */.eW)(processAndSetConfigs, "processAndSetConfigs");
...
(0,chunk_6DBFFHIP/* __name */.eW)(mermaid_core_parse, "parse");
var cssImportantStyles = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((cssClass, element, cssClasses = []) => {
  return `
.${cssClass} ${element} { ${cssClasses.join(" !important; ")} !important; }`;
}, "cssImportantStyles");
var createCssStyles = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((config, classDefs = /* @__PURE__ */ new Map()) => {
  let cssStyles = "";
...
var createUserStyles = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((config, graphType, classDefs, svgId) => {
  const userCSSstyles = createCssStyles(config, classDefs);
  const allStyles = (0,chunk_6DBFFHIP/* styles_default */.Ee)(graphType, userCSSstyles, config.themeVariables);
  return serialize(compile(`${svgId}{${allStyles}}`), stringify);
}, "createUserStyles");
var cleanUpSvgCode = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((svgCode = "", inSandboxMode, useArrowMarkerUrls) => {
  ...
  cleanedUpSvg = (0,chunk_7DKRZKHE/* decodeEntities */.SH)(cleanedUpSvg);
  cleanedUpSvg = cleanedUpSvg.replace(/<br>/g, "<br/>");
  return cleanedUpSvg;
}, "cleanUpSvgCode");
var putIntoIFrame = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((svgCode = "", svgElement) => {
...
var appendDivSvgG = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((parentRoot, id26, enclosingDivId, divStyle, svgXlink) => {
...
(0,chunk_6DBFFHIP/* __name */.eW)(sandboxedIframe, "sandboxedIframe");
var removeExistingElements = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((doc, id26, divId, iFrameId) => {
  doc.getElementById(id26)?.remove();
  doc.getElementById(divId)?.remove();
  doc.getElementById(iFrameId)?.remove();
}, "removeExistingElements");
var render = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async function(id26, text, svgContainingElement) {
  addDiagrams();
  const processed = processAndSetConfigs(text);
  text = processed.code;
  const config = (0,chunk_6DBFFHIP/* getConfig */.iE)();
  chunk_6DBFFHIP/* log */.cM.debug(config);
  ...
  const removeTempElements = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
  ...
  try {
    await diag.renderer.draw(text, id26, chunk_K6PMAZHR/* version */.i, diag);
  } catch (e) {
    if (config.suppressErrorRendering) {
      removeTempElements();
    } else {
      errorRenderer_default.draw(text, id26, chunk_K6PMAZHR/* version */.i);
    }
    throw e;
  }
  ...
  chunk_6DBFFHIP/* log */.cM.debug("config.arrowMarkerAbsolute", config.arrowMarkerAbsolute);
  svgCode = cleanUpSvgCode(svgCode, isSandboxed, (0,chunk_6DBFFHIP/* evaluate */.ku)(config.arrowMarkerAbsolute));
  if (isSandboxed) {
...
function initialize(userOptions = {}) {
  const options = (0,chunk_6DBFFHIP/* assignWithDepth_default */.Yc)({}, userOptions);
  ...
  (0,chunk_6DBFFHIP/* saveConfigFromInitialize */.dY)(options);
  if (options?.theme && options.theme in chunk_6DBFFHIP/* themes_default */._j) {
    options.themeVariables = chunk_6DBFFHIP/* themes_default */._j[options.theme].getThemeVariables(
      options.themeVariables
    );
  } else if (options) {
    options.themeVariables = chunk_6DBFFHIP/* themes_default */._j.default.getThemeVariables(options.themeVariables);
  }
  const config = typeof options === "object" ? (0,chunk_6DBFFHIP/* setSiteConfig */.Yn)(options) : (0,chunk_6DBFFHIP/* getSiteConfig */.ZD)();
  (0,chunk_6DBFFHIP/* setLogLevel */.Ub)(config.logLevel);
  addDiagrams();
}
(0,chunk_6DBFFHIP/* __name */.eW)(initialize, "initialize");
var getDiagramFromText = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((text, metadata = {}) => {
...
(0,chunk_6DBFFHIP/* __name */.eW)(addA11yInfo, "addA11yInfo");
var mermaidAPI = Object.freeze({
  render,
  parse: mermaid_core_parse,
  getDiagramFromText,
  initialize,
  getConfig: chunk_6DBFFHIP/* getConfig */.iE,
  setConfig: chunk_6DBFFHIP/* setConfig */.v6,
  getSiteConfig: chunk_6DBFFHIP/* getSiteConfig */.ZD,
  updateSiteConfig: chunk_6DBFFHIP/* updateSiteConfig */.Tb,
  reset: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
    (0,chunk_6DBFFHIP/* reset */.mc)();
  }, "reset"),
  globalReset: /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => {
    (0,chunk_6DBFFHIP/* reset */.mc)(chunk_6DBFFHIP/* defaultConfig */.u_);
  }, "globalReset"),
  defaultConfig: chunk_6DBFFHIP/* defaultConfig */.u_
});
(0,chunk_6DBFFHIP/* setLogLevel */.Ub)((0,chunk_6DBFFHIP/* getConfig */.iE)().logLevel);
(0,chunk_6DBFFHIP/* reset */.mc)((0,chunk_6DBFFHIP/* getConfig */.iE)());

// src/mermaid.ts
var handleError = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((error, errors, parseError) => {
  chunk_6DBFFHIP/* log */.cM.warn(error);
  if ((0,chunk_7DKRZKHE/* isDetailedError */.bZ)(error)) {
    if (parseError) {
...
var run = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async function(options = {
  querySelector: ".mermaid"
}) {
  try {
    await runThrowsErrors(options);
  } catch (e) {
    if ((0,chunk_7DKRZKHE/* isDetailedError */.bZ)(e)) {
      chunk_6DBFFHIP/* log */.cM.error(e.str);
    }
    if (mermaid.parseError) {
      mermaid.parseError(e);
    }
    if (!options.suppressErrors) {
      chunk_6DBFFHIP/* log */.cM.error("Use the suppressErrors option to suppress these errors");
      throw e;
    }
  }
}, "run");
var runThrowsErrors = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async function({ postRenderCallback, querySelector, nodes } = {
  querySelector: ".mermaid"
}) {
  const conf = mermaidAPI.getConfig();
  chunk_6DBFFHIP/* log */.cM.debug(`${!postRenderCallback ? "No " : ""}Callback function found`);
  let nodesToProcess;
  if (nodes) {
  ...
  chunk_6DBFFHIP/* log */.cM.debug(`Found ${nodesToProcess.length} diagrams`);
  if (conf?.startOnLoad !== void 0) {
    chunk_6DBFFHIP/* log */.cM.debug("Start On Load: " + conf?.startOnLoad);
    mermaidAPI.updateSiteConfig({ startOnLoad: conf?.startOnLoad });
  }
  const idGenerator = new chunk_7DKRZKHE/* utils_default */.w8.InitIDGenerator(conf.deterministicIds, conf.deterministicIDSeed);
  let txt;
  const errors = [];
  for (const element of Array.from(nodesToProcess)) {
    chunk_6DBFFHIP/* log */.cM.info("Rendering diagram: " + element.id);
    ...
    txt = (0,esm/* dedent */.Z)(chunk_7DKRZKHE/* utils_default */.w8.entityDecode(txt)).trim().replace(/<br\s*\/?>/gi, "<br/>");
    const init2 = chunk_7DKRZKHE/* utils_default */.w8.detectInit(txt);
    if (init2) {
      chunk_6DBFFHIP/* log */.cM.debug("Detected early reinit: ", init2);
    }
    try {
...
var initialize2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(config) {
  mermaidAPI.initialize(config);
}, "initialize");
var init = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async function(config, nodes, callback) {
  chunk_6DBFFHIP/* log */.cM.warn("mermaid.init is deprecated. Please use run instead.");
  if (config) {
    initialize2(config);
  }
...
var registerExternalDiagrams = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async (diagrams, {
  lazyLoad = true
} = {}) => {
  addDiagrams();
  (0,chunk_6DBFFHIP/* registerLazyLoadedDiagrams */.KO)(...diagrams);
  if (lazyLoad === false) {
    await loadRegisteredDiagrams();
  }
}, "registerExternalDiagrams");
var contentLoaded = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function() {
  if (mermaid.startOnLoad) {
    const { startOnLoad } = mermaidAPI.getConfig();
    if (startOnLoad) {
      mermaid.run().catch((err) => chunk_6DBFFHIP/* log */.cM.error("Mermaid failed to initialize", err));
    }
  }
}, "contentLoaded");
...
var setParseErrorHandler = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(function(parseErrorHandler) {
  mermaid.parseError = parseErrorHandler;
}, "setParseErrorHandler");
var executionQueue = [];
var executionQueueRunning = false;
var executeQueue = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async () => {
  ...
  while (executionQueue.length > 0) {
    ...
    if (f) {
      try {
        ...
        chunk_6DBFFHIP/* log */.cM.error("Error executing queue", e);
      }
    }
  }
  executionQueueRunning = false;
}, "executeQueue");
var parse2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(async (text, parseOptions) => {
  return new Promise((resolve, reject) => {
    const performCall = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => new Promise((res, rej) => {
      mermaidAPI.parse(text, parseOptions).then(
        ...
        (e) => {
          chunk_6DBFFHIP/* log */.cM.error("Error parsing", e);
          mermaid.parseError?.(e);
          rej(e);
          reject(e);
        }
...
var render2 = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)((id26, text, container) => {
  return new Promise((resolve, reject) => {
    const performCall = /* @__PURE__ */ (0,chunk_6DBFFHIP/* __name */.eW)(() => new Promise((res, rej) => {
...
var mermaid = {
  ...
  run,
  registerExternalDiagrams,
  registerLayoutLoaders: chunk_BO7VGL7K/* registerLayoutLoaders */.jM,
  initialize: initialize2,
  parseError: void 0,
  contentLoaded,
  setParseErrorHandler,
  detectType: chunk_6DBFFHIP/* detectType */.Vg,
  registerIconPacks: chunk_OPO4IU42/* registerIconPacks */.ef
};
